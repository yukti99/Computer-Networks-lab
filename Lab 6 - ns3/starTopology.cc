...
#include "ns3/netanim-module.h"
 ...
 int  main (int argc, char *argv[]){
   ...
   // To set the position of nodes in star topology     
  AnimationInterface anim("starTopology.xml");
  anim.SetConstantPosition(serverNode.Get(0),37.5,39.0);
  anim.SetConstantPosition(clientNodes.Get(0),37.5,39.0);
  anim.SetConstantPosition(clientNodes.Get(1),75.0,39.0);
  anim.SetConstantPosition(clientNodes.Get(2),0.0,39.0);
  anim.SetConstantPosition(clientNodes.Get(3),37.5,0.0);
  anim.SetConstantPosition(clientNodes.Get(4),0.0,0.0);
  anim.SetConstantPosition(clientNodes.Get(5),75.0,78.0);
  anim.SetConstantPosition(clientNodes.Get(6),0.0,78.0);
  anim.SetConstantPosition(clientNodes.Get(7),75.0,0.0);  
