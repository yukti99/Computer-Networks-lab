...
//
  ...
  Simulator::Stop (Seconds(100.0));
	...
	AnimationInterface anim("dumbellTopology.xml");
	anim.SetConstantPosition(c.Get(0),0.0,72.0);
	anim.SetConstantPosition(c.Get(1),0.0,18.0);
	anim.SetConstantPosition(c.Get(2),98.0,72.0);
	anim.SetConstantPosition(c.Get(3),98.0,18.0);
	anim.SetConstantPosition(c.Get(4),24.5,44.0);
	anim.SetConstantPosition(c.Get(5),73.5,44.0);
